...
const ProductBuyNowPage = () => {
  ...
  return (
    <div className="flex mt-24 ml-[230px] items-center h-screen bg-white">
      <div className="flex bg-white rounded-lg  p-5 max-w-4xl">
        ...
        <div className=" ml-24 mt-8">
          ...
          <p className="text-gray-600 mb-4">
            ...
            <br /> Tender and flavorful, it's perfect for grilling, roasting,or
            stews. Elevate your meals with our quality cuts.
          </p>
